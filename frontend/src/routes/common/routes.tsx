...
import Calendar from "@/pages/calendar/MyCalendar"; // ✅ import calendar page
...
export const protectedRoutePaths = [
  ...
  { path: PROTECTED_ROUTES.AVAILABILITY, element: <Availability /> }, // ✅ fixed typo
  { path: PROTECTED_ROUTES.INTEGRATIONS, element: <Integrations /> },
  { path: PROTECTED_ROUTES.CALENDAR, element: <Calendar /> }, // ✅ added calendar route
];
